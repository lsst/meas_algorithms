...
private:
    ...
    PersistenceHelper() :
        ...
        inputDataSchema(),
        transmission(inputDataSchema.addField<int>("transmission", "archive ID for this sensor's TransmissionCurve")),
        sensorWcs(inputDataSchema.addField<int>("sensorWcs", "archive ID for this sensor's WCS")),
        validPolygon(inputDataSchema.addField<int>("validPolygon", "archive ID for this sensor's ValidPolygon")),
        bbox(afw::table::Box2DKey::addFields(inputDataSchema, "bbox", "bounding box of the sensor", "pixel")),
        weight(inputDataSchema.addField<double>("weight", "relative weight for this sensor in the average"))
    {
