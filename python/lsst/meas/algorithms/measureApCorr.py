...
class MeasureApCorrConfig(lsst.pex.config.Config):
    ...
    doMedianShift = lsst.pex.config.Field(
...
class MeasureApCorrTask(Task):
    ...
    **kwargs : `dict`
    ...
    def __init__(self, schema, correctNames=None, **kwargs):
        ...
        names = correctNames if correctNames else getApCorrNameSet()
